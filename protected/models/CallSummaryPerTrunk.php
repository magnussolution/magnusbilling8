...
class  CallSummaryPerTrunk extends Model
{
    ...
    {
        $rules = [
            [['id_trunk'], 'integer', 'integerOnly' => true],
            [['sessiontime', 'sessionbill', 'nbcall', 'buycost', 'lucro', 'aloc_all_calls', 'sumaloc_all_calls'], 'string', 'max' => 50],
        ];
        return $this->getExtraField($rules);
    }
    public function getIdTrunk()
    {
        return $this->hasOne(Trunk::className(), ['id' => 'id_trunk']);
    }
}
