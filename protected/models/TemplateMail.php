...
class  TemplateMail extends Model
{
    ...
    {
        $rules = [
            [['id_user', 'status'], 'integer', 'integerOnly' => true],
            [['mailtype'], 'string', 'max' => 50],
            [['fromname, fromemail', 'language'], 'string', 'max' => 70],
            [['subject'], 'string', 'max' => 130],
            [['messagehtml'], 'string', 'max' => 3000],
        ];
