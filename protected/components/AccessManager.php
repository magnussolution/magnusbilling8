...
class AccessManager
{
    ...
    {
        if (in_array($this->module, self::$config['only_admin']) && !Yii::$app->session->get('isAdmin')) {
            return false;
        }
    ...
    public static function checkAccess($user, $pass)
    {
    ...
    public static function checkAccessLogin($user, $pass)
    {
