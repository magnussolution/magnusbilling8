...
class  Configuration extends Model
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['config_title', 'config_key'], 'string', 'max' => 100],
            [['config_value'], 'string', 'max' => 200],
            [['config_description'], 'string', 'max' => 500],
            [['config_group_title'], 'string', 'max' => 64],
    ...
    {
        $modelConfig = Configuration::find()->all();
