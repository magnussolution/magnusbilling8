...
class  Did extends Model
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['fixrate'], 'integer'],
            [['did,callerid', 'country'], 'string', 'max' => 50],
            [['description'], 'string', 'max' => 150],
            [['expression_1', 'expression_2', 'expression_2', 'expression_3', 'TimeOfDay_monFri', 'TimeOfDay_sat', 'TimeOfDay_sun', 'workaudio', 'noworkaudio'], 'string', 'max' => 150],
            [
                'connection_charge',
                'selling_rate_1',
                'selling_rate_2',
