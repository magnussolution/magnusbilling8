...
class  Campaign extends Model
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['id_user', 'digit_authorize', 'id_plan', 'restrict_phone', 'secondusedreal', 'enable_max_call', 'nb_callmade', 'type', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'status', 'frequency', 'auto_reprocess', 'max_frequency'], 'integer', 'integerOnly' => true],
            [['name', 'audio', 'audio_2', 'record_call', 'callerid'], 'string', 'max' => 100],
            [['startingdate', 'expirationdate'], 'string', 'max' => 50],
            [['daily_start_time', 'daily_stop_time'], 'string', 'max' => 8],
            [['forward_number'], 'string', 'max' => 160],
            [['description'], 'string', 'max' => 300],
            [['tts_audio', 'tts_audio2', 'asr_audio', 'asr_options'], 'string', 'max' => 200],
            [['from'], 'string', 'max' => 20],
        ];
