    ...
    <form method="POST" action="" class="form-style-9">
        ...
        <div class="col1">
            ...
            <div id="payment-details-action">
                ...
                <button onclick="window.location='../../index.php/buy-credit/method/?mobile=true';" id="button-next" class="btn btn-primary">Cancel &raquo;</button>
...
<style type="text/css">
    ...
    #payment-details-action #payment-info-container,
    #payment-details-action .payment-info {
        width: 100px
    }
    ...
    #amount-selection .other-amounts,
    #payment-selection .more-payments.sub,
    #payment-selection .disabled-payments {
        margin-top: -20px;
        margin-bottom: 10px
    }
    ...
    #component-buy-options .item-block.not_clickable .box,
    #component-buy-options .item-block.not_clickable .logo {
        cursor: auto
    }
