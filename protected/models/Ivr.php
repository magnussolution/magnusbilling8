...
class  Ivr extends Model
{
    ...
    {
        $rules = [
            [['id_user', 'use_holidays', 'direct_extension'], 'integer', 'integerOnly' => true],
            [['monFriStart',  'satStart', 'sunStart'], 'string', 'max' => 200],
            [['name', 'option_0', 'option_1', 'option_2', 'option_3', 'option_4', 'option_5', 'option_6', 'option_7', 'option_8', 'option_9', 'option_10'], 'string', 'max' => 50],
            [['option_out_0', 'option_out_1', 'option_out_2', 'option_out_3', 'option_out_4', 'option_out_5', 'option_out_6', 'option_out_7', 'option_out_8', 'option_out_9', 'option_out_10'], 'string', 'max' => 50],
