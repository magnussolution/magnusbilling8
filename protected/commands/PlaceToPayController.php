...
class PlaceToPayController extends ConsoleCommand
{
    ...
    public function actionRun($args = '')
    {
        ...
        $modelMethodPay = Methodpay::find()->where(['like', 'payment_method', 'PlacetoPay'])->one();
        ...
        try {
            ...
            $p2p         = new PlacetoPay();
            $modelRefill = Refill::find()->where(['like', 'description', 'pendiente'])->andWhere(['payment' => 0])->all();
