...
echo "
8 8 * * * php /var/www/html/mbilling/cron.php servicescheck/run
* * * * * php /var/www/html/mbilling/cron.php callchart/run
1 * * * * php /var/www/html/mbilling/cron.php NotifyClient/run
1 22 * * * php /var/www/html/mbilling/cron.php DidCheck/run
1 23 * * * php /var/www/html/mbilling/cron.php PlanCheck/run
0 2 * * * php /var/www/html/mbilling/cron.php Backup/run
0 4 * * * /var/www/html/mbilling/protected/commands/clear_memory/run
*/2 * * * * php /var/www/html/mbilling/cron.php SummaryTablesCdr/run
*/3 * * * * php /var/www/html/mbilling/cron.php PhoneBooksReprocess/run
* * * * * php /var/www/html/mbilling/cron.php statussystem/run
* * * * * php /var/www/html/mbilling/cron.php didwww/run
*/5 * * * * php /var/www/html/mbilling/cron.php alarm/run
* * * * * php /var/www/html/mbilling/cron.php TrunkSIPCodes/run
59 23 * * * php /var/www/html/mbilling/cron.php NotifyClientDaily/run
" > $CRONPATH
chmod 600 $CRONPATH

echo "
* * * * * root php /var/www/html/mbilling/cron.php cryptocurrency/run
">> /etc/crontab
