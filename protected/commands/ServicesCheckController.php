...
class ServicesCheckController extends ConsoleCommand
{
    private $userNotify = [];
    ...
    {
        $modelServiceUser = ServicesUse::find()->where(['status' => 1])->all();
        ...
        foreach ($modelServiceUser as $service) {
            ...
            $timestamp_datetopay = mktime(
                ...
                date("m", $diff_reservation_daytopay) + $service['month_payed'],
