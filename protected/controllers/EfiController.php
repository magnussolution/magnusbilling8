...
class EfiController extends CController
{
    public function actionIndex()
    {
        ...
        if (isset($_GET['id_user']) && isset($_GET['id']) && isset($_GET['amount']) && isset($_POST['notification'])) {
            ...
            Yii::error(print_r($sql, true), 'error');
            ...
            try {
                ...
                Yii::error('statusAtual' . $statusAtual, 'error');
                ...
                switch ($statusAtual) {
                    ...
                    case 'canceled':
                        ...
                        break;
                    case 'waiting':
                        Yii::error("Cobrança Aguardando pagamento", 'error');
